...
const Aurora = () => {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      <div className="absolute left-1/2 top-1/2 h-[50vh] w-[80vw] -translate-x-1/2 -translate-y-1/2 rounded-full blur-3xl opacity-40" style={{
  ...
  return (
    <section className="relative py-12 md:py-20">
      ...
      <div className="container mx-auto text-center max-w-4xl px-2">
        <span className="inline-flex items-center gap-1.5 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs text-primary mb-3 animate-fade-in">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4 text-xs text-muted-foreground">
          <div className="inline-flex items-center gap-1.5"><Users className="h-3.5 w-3.5" /> Up to 8 players</div>
          <div className="inline-flex items-center gap-1.5"><Zap className="h-3.5 w-3.5" /> Lightning fast rounds</div>
        </div>
      </div>
    </section>
  );
