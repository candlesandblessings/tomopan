  ...
  useEffect(() => {
    ...
    const initializeGame = async () => {
      try {
        ...
        // Set initial time left based on room duration
        ...
        if (roundData) {
          ...
          setTimeLeft(roundData.duration || roomData.duration || 60);
      ...
      .on(
        ...
        (payload) => {
          if (payload.new.status === "active") {
            ...
            setTimeLeft(payload.new.duration || room?.duration || 60);
            setGameStatus("playing");
                ...
                {players.map((player) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-xs font-medium">{playerI need to complete the GameRoom.tsx file that was cut off:

<dyad-write path="src/pages/GameRoom.tsx" description="Completing GameRoom page with room settings">
import { useEffect, useState, useRef } from "react";
import { useParams, useNavigate } from "react-router-dom";
import { supabase } from "@/integrations/supabase/client";
import { Button } from "@/components/ui/button";
